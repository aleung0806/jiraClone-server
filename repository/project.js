...
const getAllProjects = async () => {
  let projects = await db
    .select('project.projectId', 'project.title as projectTitle', 'list.listId', 'list.title as listTitle', 'issue.*')
    .from('project')
    .leftJoin('list', 'project.projectId', 'list.projectId')
    .leftJoin('issue', 'list.listId', 'issue.listId')
